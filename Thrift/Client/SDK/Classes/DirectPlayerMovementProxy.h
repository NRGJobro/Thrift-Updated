...
public:
	...
	virtual Vec3<float> getSlideOffset(void);
	virtual void setSlideOffset(Vec3<float> const&);
	virtual void setTerrainSurfaceOffset(float);
	virtual Vec3<float> getBlockMovementSlowdownMultiplier(void);
	virtual void setBlockMovementSlowdownMultiplier(BlockLegacy const&, Vec3<float> const&);
	...
	virtual Vec3<float> getPosDeltaNonConst2(void);
